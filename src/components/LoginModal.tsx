            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[480px] bg-[#0F0F0F] border border-white/5 rounded-3xl p-0 z-50 shadow-2xl overflow-hidden"
                    >
                        {/* Header Area */}
                        <div className="relative p-8 pb-0">
                            ...
                            <div className="absolute top-6 right-6 flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="group flex items-center gap-2 bg-white text-black pl-3 pr-4 py-2 rounded-full font-medium text-sm hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all transform hover:scale-105"
                                >
