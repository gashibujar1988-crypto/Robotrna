...
const MotherPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900 overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-100/50 via-gray-50 to-gray-50 z-0" />
            ...
            <div className="relative z-10 container mx-auto px-6 pt-32 pb-12">
                ...
                <div className="flex items-center justify-end mb-16">
                    <div className="px-4 py-1 rounded-full bg-purple-100 border border-purple-200 text-purple-700 text-xs font-bold tracking-widest uppercase">
                        Systemstatus: Online
                    </div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="relative w-[500px] h-[700px] rounded-[3rem] overflow-hidden border-2 border-gray-200 shadow-2xl bg-white backdrop-blur-sm">
                            <img
                                src={motherFull}
                                alt="Mother Core AI"
                        ...
                        <motion.div
                            ...
                            className="absolute top-20 -right-10 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-gray-100 shadow-2xl"
                        >
                            <Brain className="w-8 h-8 text-purple-600 mb-2" />
                            <div className="text-xs text-gray-500">Neural Kapacitet</div>
                            <div className="text-lg font-bold text-gray-900">100 PB</div>
                        </motion.div>

                        <motion.div
                            animate={{ y: [10, -10, 10] }}
                            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                            className="absolute bottom-40 -left-10 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-gray-100 shadow-2xl"
                        >
                            <Network className="w-8 h-8 text-pink-500 mb-2" />
                            <div className="text-xs text-gray-500">Anslutna Agenter</div>
                            <div className="text-lg font-bold text-gray-900">9 Aktiva</div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={i} className="bg-white border border-gray-100 rounded-xl p-5 hover:shadow-lg transition-all">
                ...
                >
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Orkestrering i Världsklass</h2>
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-md hover:shadow-xl hover:border-purple-200 transition-all group">
                                <div className="w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center mb-4 text-purple-600 group-hover:scale-110 transition-transform">
                ...
                >
                    <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
                        <div className="order-2 md:order-1">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Hive-Mind Arkitektur</h2>
                        ...
                        <div className="order-1 md:order-2 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 border border-white/50 shadow-inner relative overflow-hidden">
                            <div className="relative z-10 space-y-4">
                                <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-purple-100 shadow-sm">
                                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold">S</div>
                                    <div className="text-sm text-gray-700">
                                        <span className="text-purple-600 font-bold">@Sälj</span> hittade ny kundinsikt.
                                    </div>
                                </div>
                                <div className="flex justify-center">
                                    <ArrowLeft className="rotate-[-90deg] text-gray-300" />
                                </div>
                                <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-purple-200 shadow-[0_0_30px_rgba(168,85,247,0.1)]">
                                ...
                                <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-purple-100 shadow-sm">
                                    ...
                                    <div className="text-sm text-gray-700">
                                        <span className="text-purple-600 font-bold">@Marknad</span> justerar kampanj.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-xl">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Mother vs. Traditionell Automation</h2>
                            <p className="text-gray-500">Varför världens ledande företag väljer en orkestrerad lösning.</p>
                        </div>

                        <div className="grid md:grid-cols-3 gap-8">
                            {/* Competitors */}
                            <div className="space-y-6 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
                                <div className="text-xl font-bold text-gray-400 text-center mb-8">Vanliga Chatbots</div>
                                {[
                            ...
                            {/* Mother */}
                            <div className="relative md:-mt-8 md:-mb-8 bg-gray-900 rounded-3xl p-6 border border-gray-800 shadow-2xl z-10 transform md:scale-105">
                            ...
                            <div className="space-y-6 opacity-80 md:pt-4">
                                <div className="text-xl font-bold text-gray-400 text-center mb-8">Mänskliga Konsulter</div>
                                {[
